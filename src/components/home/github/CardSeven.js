...
export default function CardSeven() {
  return (
    <div class="bg-black  rounded-3xl flex items-center justify-center static relative p-10 h-[310px] hover:shadow-lg">
      <a href="https://github.com/singhakshay29" target="_blank">
        <svg
